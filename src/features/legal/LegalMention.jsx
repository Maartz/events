        ...
        <div>
            ...
            <p>En vertu de l'article 6 de la loi n° 2004-575 du 21 juin 2004 pour la confiance dans l'économie
                numérique, il est précisé aux utilisateurs du site <a
                    href="http://www.eventsapp.maartz.fr/">www.eventsapp.maartz.fr</a> l'identité des différents intervenants
                dans le cadre de sa réalisation et de son suivi :</p>
            <p><strong>Propriétaire</strong> : William Martin – – 12 Bis rue Gabriel Peri<br/>
                <strong>Créateur</strong> : <a href="http://maartz.fr">MARTIN</a><br/>
                <strong>Responsable publication</strong> : William Martin – w.martin38@icloud.com<br/>
                Le responsable publication est une personne physique ou une personne morale.<br/>
                <strong>Webmaster</strong> : William Martin – w.martin38@icloud.com<br/>
                <strong>Hébergeur</strong> : netlify.com – 2325 3rd St #215, San Francisco, CA 94107, États-Unis<br/>
                Crédits : <br/>
            ...
            <p>L’utilisation du site <a href="http://www.eventsapp.maartz.fr/" rel="noopener noreferrer" target="_blank"   >www.eventsapp.maartz.fr</a> implique
                ...
                site <a href="http://www.eventsapp.maartz.fr/" rel="noopener noreferrer" target="_blank"   >www.eventsapp.maartz.fr</a> sont donc invités à les consulter
                de manière régulière.</p>
            <p>Ce site est normalement accessible à tout moment aux utilisateurs. Une interruption pour raison de
                maintenance technique peut être toutefois décidée par William Martin, qui s’efforcera alors de
                communiquer préalablement aux utilisateurs les dates et heures de l’intervention.</p>
            <p>Le site <a href="http://www.eventsapp.maartz.fr/" rel="noopener noreferrer" target="_blank"   >www.eventsapp.maartz.fr</a> est mis à jour régulièrement par
                William Martin. De la même façon, les mentions légales peuvent être modifiées à tout moment : elles
            ...
            <p>Le site <a href="http://www.eventsapp.maartz.fr/" rel="noopener noreferrer" target="_blank"   >www.eventsapp.maartz.fr</a> a pour objet de fournir une
                information concernant l’ensemble des activités de la société.</p>
            <p>William Martin s’efforce de fournir sur le site <a
                href="http://www.eventsapp.maartz.fr/" rel="noopener noreferrer" target="_blank" >www.eventsapp.maartz.fr</a> des informations aussi précises que
            ...
            <p>Tous les informations indiquées sur le site <a
                href="http://www.eventsapp.maartz.fr/" rel="noopener noreferrer" target="_blank" >www.eventsapp.maartz.fr</a> sont données à titre indicatif, et sont
                susceptibles d’évoluer. Par ailleurs, les renseignements figurant sur le site <a
                    href="http://www.eventsapp.maartz.fr/" rel="noopener noreferrer" target="_blank" >www.eventsapp.maartz.fr</a> ne sont pas exhaustifs. Ils sont donnés
            ...
            <p>William Martin est propriétaire des droits de propriété intellectuelle ou détient les droits d’usage sur
            ...
            <p>William Martin ne pourra être tenue responsable des dommages directs et indirects causés au matériel de
                l’utilisateur, lors de l’accès au site www.eventsapp.maartz.fr, et résultant soit de l’utilisation d’un
            ...
            <p>William Martin ne pourra également être tenue responsable des dommages indirects (tels par exemple qu’une
                perte de marché ou perte d’une chance) consécutifs à l’utilisation du site <a
                    href="http://www.eventsapp.maartz.fr/" rel="noopener noreferrer" target="_blank" >www.eventsapp.maartz.fr</a>.</p>
            <p>Des espaces interactifs (possibilité de poser des questions dans l’espace contact) sont à la disposition
                des utilisateurs. William Martin se réserve le droit de supprimer, sans mise en demeure préalable, tout
                contenu déposé dans cet espace qui contreviendrait à la législation applicable en France, en particulier
                aux dispositions relatives à la protection des données. Le cas échéant, William Martin se réserve
            ...
            <p>En France, les données personnelles sont notamment protégées par la loi n° 78-87 du 6 janvier 1978, la
                ...
                octobre 1995.</p>
            <p>A l'occasion de l'utilisation du site <a href="http://www.eventsapp.maartz.fr/" rel="noopener noreferrer" target="_blank"   >www.eventsapp.maartz.fr</a>,
                peuvent êtres recueillies : l'URL des liens par l'intermédiaire desquels l'utilisateur a accédé au
                site <a href="http://www.eventsapp.maartz.fr/" rel="noopener noreferrer" target="_blank"   >www.eventsapp.maartz.fr</a>, le fournisseur d'accès de
                l'utilisateur, l'adresse de protocole Internet (IP) de l'utilisateur.</p>
            <p> En tout état de cause William Martin ne collecte des informations personnelles relatives à l'utilisateur
                que pour le besoin de certains services proposés par le site <a
                    href="http://www.eventsapp.maartz.fr/" rel="noopener noreferrer" target="_blank" >www.eventsapp.maartz.fr</a>. L'utilisateur fournit ces informations
                en toute connaissance de cause, notamment lorsqu'il procède par lui-même à leur saisie. Il est alors
                précisé à l'utilisateur du site <a
                    href="http://www.eventsapp.maartz.fr/" rel="noopener noreferrer" target="_blank" >www.eventsapp.maartz.fr</a> l’obligation ou non de fournir ces
                informations.</p>
            ...
            <p>Aucune information personnelle de l'utilisateur du site <a
                href="http://www.eventsapp.maartz.fr/" rel="noopener noreferrer" target="_blank" >www.eventsapp.maartz.fr</a> n'est publiée à l'insu de l'utilisateur,
                échangée, transférée, cédée ou vendue sur un support quelconque à des tiers. Seule l'hypothèse du rachat
                de William Martin et de ses droits permettrait la transmission des dites informations à l'éventuel
            ...
            <p>Le site <a href="http://www.eventsapp.maartz.fr/" rel="noopener noreferrer" target="_blank"   >www.eventsapp.maartz.fr</a> contient un certain nombre de
                liens hypertextes vers d’autres sites, mis en place avec l’autorisation de William Martin. Cependant,
                William Martin n’a pas la possibilité de vérifier le contenu des sites ainsi visités, et n’assumera en
                conséquence aucune responsabilité de ce fait.</p>
            <p>La navigation sur le site <a href="http://www.eventsapp.maartz.fr/" rel="noopener noreferrer" target="_blank"   >www.eventsapp.maartz.fr</a> est susceptible
            ...
            <p>Tout litige en relation avec l’utilisation du site <a
                href="http://www.eventsapp.maartz.fr/" rel="noopener noreferrer" target="_blank" >www.eventsapp.maartz.fr</a> est soumis au droit français. Il est fait
